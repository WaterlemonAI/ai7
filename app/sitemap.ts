...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    ...blogPosts.map((post) => ({ url: `${siteUrl}/insights/${post.slug}`, lastModified: new Date(post.publishedAt), changeFrequency: 'monthly' as const, priority: 0.8, images: [`${siteUrl}/insights/${post.slug}/opengraph-image`] })),
  ]
}
